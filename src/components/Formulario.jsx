...
const Formulario = ({ pacientes, setPacientes, paciente, setPaciente }) => {
    ...
    return (
        <div className="md:w-1/2 lg:w-2/5 mx-5">
            <h2 className="font-black text-2xl text-center">Pacientes</h2>
            ...
            >
                ...
                <div className="mb-2">
                    ...
                    <textarea 
                        id="sintomas"
                        className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"
                        placeholder="Descripcion de los Síntomas"
                        value={sintomas}
                ...
                <input
                    type="submit"
                    className="bg-gray-500 w-full  rounded-lg p-3 text-white   font-bold hover:bg-gray-700 cursor-pointer transition-colors"
